...
// Everything the app needs lives in a handful of flat, root-level files —
// no subfolders — so this works no matter how simply the repo was uploaded.

const CACHE_VERSION = 'medisaathi-single-v1';
const APP_SHELL = [
  './',
  './index.html',
  './manifest.json',
